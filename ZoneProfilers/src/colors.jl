# This table was copied from https://github.com/topolarity/Tracy.jl/blob/v0.1.4/src/colors.jl

const _available_colors = "`:black`, `:blue`, `:green`, `:cyan`, `:red`, `:magenta`, `:yellow`, `:white`, `:light_black`, `:light_blue`, `:light_green`, `:light_cyan`, `:light_red`, `:light_magenta`, `:light_yellow`, `:light_white`"
...
function _tracycolor(sym::Symbol)
    ...
    error("Unknown color: $(repr(sym)). Available colors are: $(_available_colors)")
end